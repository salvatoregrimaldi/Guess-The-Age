...
model, age_model = build_model("resnet50")
...
model, age_model = build_model("resnet50")
model.load_weights(filepath = '/user/2022_va_gr07/AVProject/model_saves/' +model_name +'_repr' +'.h5')
print('Model ' +'/user/2022_va_gr07/AVProject/model_saves/' +model_name +'_repr' +'.h5' +' correctly loaded')
...
age_model.layers[-1].set_weights(build_model("resnet50")[1].layers[-1].get_weights())
